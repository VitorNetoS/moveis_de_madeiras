...
var foto_funcionario = document.getElementById("foto-funcionario");
if (inputFile != null && inputFile.addEventListener) {                   
    inputFile.addEventListener("change", function(){loadFoto(this, foto_funcionario)});
} else if (inputFile != null && inputFile.attachEvent) {                  
    inputFile.attachEvent("onchange", function(){loadFoto(this, foto_funcionario)});
}
...
function confirmaExclusao(id){
	...
	if (retorno){
		 ...
		 formulario.action = "action_funcionario.php";
